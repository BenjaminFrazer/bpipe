...
char err_lut[Bp_EC_MAX][100] = {
  ...
  ERR_LUT_ENTRY(INVALID_CONFIG_MAX_INPUTS),  /* Invalid configuration parameters */
  ERR_LUT_ENTRY(INVALID_CONFIG_MAX_SINKS),  /* Invalid configuration parameters */
  ERR_LUT_ENTRY(INVALID_CONFIG_FILTER_SIZE),  /* Invalid configuration parameters */
  ERR_LUT_ENTRY(INVALID_CONFIG_FILTER_T),  /* Invalid configuration parameters */
  ERR_LUT_ENTRY(INVALID_CONFIG_TIMEOUT),  /* Invalid configuration parameters */
