...
- **Updated**: 2025-06-29 after analyzing py-tests patterns
- **Priority**: High - affects all Python filter functionality
- **Impact**: Threading/execution model broken, manual workaround available
...
---
**Created**: 2025-06-29  
**Author**: Demo modernization investigation  
**Tags**: framework, python-bindings, data-flow, high-priority