...
void test_pipeline_linear_chain(void) {
    ...
    Map_config_t multiply_by_2_config = {
        .name = "gain_x2",
...
void test_pipeline_multi_branch_dag(void) {
    ...
    // Tee configuration
    BatchBuffer_config output_configs[] = {
        default_buffer_config(),
        default_buffer_config()
    };
    
    Tee_config_t tee_config_2_outputs = {
        .name = "splitter",
        .buff_config = default_buffer_config(),
        .n_outputs = 2,
    ...
    Map_config_t multiply_by_3_config = {
        .name = "gain_x3",
        .buff_config = default_buffer_config(),
    ...
    Connection_t connections[] = {
        ...
        // Note: Since we're using a simple map as combiner, we can't have multiple inputs
        // This is a limitation for this test - in real usage, we'd use a proper mixer
    };
